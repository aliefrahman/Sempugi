...
<?php if ( ! empty($comments_by_type['comment']) ) : ?>
    ...
    <div id="comments-list" class="comments">
     <h3><?php printf($comment_count > 1 ? __('<span>%d</span> Komentar ', 'Continent') : __('<span>1</span> Komentar ', 'Continent'), $comment_count) ?></h3>
...
<?php if ( 'open' == $post->comment_status ) : ?>
    <div id="respond">
        <h3><?php comment_form_title( __('Masukkan Komentar', 'your-theme'), __('Balas Komentar %s', 'your-theme') ); ?></h3>
...
<?php else : ?>
       ...
       <p id="comment-notes"><?php _e('Email Anda <em>tidak pernah</em> dipublikasikan atau disebarkan.', 'your-theme') ?> <?php if ($req) _e('Yang harus diisi<span class="required">*</span>', 'your-theme') ?></p>
...
<?php endif /* if ( $user_ID ) */ ?>
        ...
        <div class="form-label"><label for="comment"><?php _e('Comment', 'your-theme') ?></label> <?php if ($req) _e('<span class="required">*</span>', 'your-theme') ?></div>
